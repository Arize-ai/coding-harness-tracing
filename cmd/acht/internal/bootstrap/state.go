...
// State is persisted to ~/.arize/acht/state.json.
type State struct {
...
// LoadState reads ~/.arize/acht/state.json. A missing file yields an
...
// SaveState writes ~/.arize/acht/state.json, creating the parent
